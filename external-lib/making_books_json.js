...
for (var i = 0; i < 100; i++) {
    ...
    console.log(
      ...
      "bId": "${i + 100000}00",
      "bAuthors": ${a},
      "bCategorys": ["category${i}", "category${i + 50}"],
      "bDetail": "language : ${book[i].language} , pages : ${book[i].pages} , year : ${book[i].year}"
    },`
    );
}
